...
//                 a 25x18 bit multiplier, do not exceed this width in the parameters. E.g. max coeff_width = 25 and max inout_width = 18, 
//                 or vice versa. 
//
...
module iir_DF1_Biquad_AXIS #(
  ...
  input  rst_n,
  input  s_axis_tvalid,
  input  m_axis_tready,  // upstream device ready
